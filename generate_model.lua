...
proto_name = './src/caffe_model/model_deploy.prototxt'
model_name = './src/caffe_model/model.caffemodel'
...
model:add(cudnn.ReLU(true))
model:add(nn.Dropout(0.500000))
model:add(cudnn.SpatialConvolution(feaLen2, 64*46, 1, 1, 1, 1, 0, 0, 1))
